...
<head>
  ...
  <title><?php echo "{$content["PersonalInfo"]["FirstName"]} {$content["personalInfo"]["LastName"]}"; ?></title>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">Bhuvan U Kadlas</a></h1>
