      ...
      <section id="about" class="about">
        <div class="container">
          <div class="section-title">
            <h2>About</h2>
            <p><?php echo $content["About"]["Desc"]; ?></p>
          </div>

          <div class="row">
            <div class="col-lg-4" data-aos="fade-right"><img src="<?php echo $content["PersonalInfo"]["Avatar"]; ?>" class="img-fluid" alt="" /></div>
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
              <h3><?php echo $content["About"]["Designation"]; ?></h3>
              <p class="fst-italic"><?php echo $content["About"]["DesigDesc"]; ?></p>
              <div class="row">
                <div class="col-lg-6">
                  <ul>
<?php foreach ($content["About"]["Details"][0] as $key => $value) { ?>
                      <li><i class="bi bi-chevron-right"></i> <strong><?php echo $key; ?>:</strong> <span><?php echo $value; ?></span></li>
<?php } ?>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul>
<?php foreach ($content["About"]["Details"][1] as $key => $value) { ?>
                      <li><i class="bi bi-chevron-right"></i> <strong><?php echo $key; ?>:</strong> <span><?php echo $value; ?></span></li>
<?php } ?>
                  </ul>
                </div>
              </div>
              <p><?php echo $content["About"]["AboutDesc"]; ?></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="facts" class="facts">
        <div class="container">
          <div class="section-title">
            <h2>Facts</h2>
            <p><?php echo $content["About"]["Facts"]["Desc"]; ?></p>
          </div>

          <div class="row no-gutters">
<?php foreach ($content["About"]["Facts"]["Counters"] as $counter) { ?>
            <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up">
              <div class="count-box">
                <i class="bi bi-<?php echo $counter["Icon"]; ?>"></i>
                <span data-purecounter-start="0" data-purecounter-end="<?php echo $counter["Value"]; ?>" data-purecounter-duration="1" class="purecounter"></span>
                <p><strong><?php echo $counter["Title"]; ?></strong><br /><?php echo $counter["Desc"]; ?></p>
              </div>
            </div>
<?php } ?>
          </div>
          ...
          <div class="row" data-aos="fade-in">
            <div class="col-lg-5 d-flex align-items-stretch">
              <div class="info">
                ...
                <iframe src="https://www.google.com/maps/d/u/0/viewer?msa=0&hl=en&ie=UTF8&ll=12.22959300000001%2C76.65161099999999&spn=0.016651%2C0.038624&t=h&z=15&mid=132uDjpCB5qV9r-ZiNy7SzSnZnpk" frameborder="0" style="border: 0; width: 100%; height: 290px" allowfullscreen></iframe>
              </div>
            </div>
